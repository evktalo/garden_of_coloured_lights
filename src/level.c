...
//    overtrack_pos2 = 0; // must reset this for every non-enemy overtrack entry!!
   ...
   if (overtrack [arena.level - 1] [overtrack_pos] [overtrack_pos2] == T_ESCORTS_1)
   {
...
//    overtrack_pos2 = 0; // must reset this for every non-enemy overtrack entry!!
   ...
   if (overtrack [arena.level - 1] [overtrack_pos] [overtrack_pos2] == T_ESCORTS_2)
   {
...
//    overtrack_pos2 = 0; // must reset this for every non-enemy overtrack entry!!
   ...
   if (overtrack [arena.level - 1] [overtrack_pos] [overtrack_pos2] == T_ESCORTS_3)
   {
...
//    overtrack_pos2 = 0; // must reset this for every non-enemy overtrack entry!!
   ...
   if (overtrack [arena.level - 1] [overtrack_pos] [overtrack_pos2] == T_ESCORTS_0)
   {
    arena.cruiser_escorts = 0;
    overtrack_pos ++;
    overtrack_pos2 = -1; // so with the increment above it'll be 0
...
//    overtrack_pos2 = 0; // must reset this for every non-enemy overtrack entry!!
  ...
  switch(s_etype)
  {
   case T_BOSS1: etype = ENEMY_BOSS1;
    ...
    break;
   case T_BOSS2: etype = ENEMY_BOSS2;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_BOSS3: etype = ENEMY_BOSS3;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_BOSS4: etype = ENEMY_BOSS4;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
   ...
   case T_CRUISER1: etype = ENEMY_CRUISER1;
    ...
    make_group_track(t, etype);
    break;
   case T_CRUISER2: etype = ENEMY_CRUISER2;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_CRUISER3: etype = ENEMY_CRUISER3;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_CRUISER4: etype = ENEMY_CRUISER4;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_CRUISER5: etype = ENEMY_CRUISER5;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 15;
    track[t].count2 = track[t].count;
   ...
   case T_BEAMER: etype = ENEMY_BEAMER;
    ...
    make_group_track(t, etype);
    break;
   case T_SHOOTER: etype = ENEMY_SHOOTER;
    track[t].type = etype;
    track[t].multiple = 2;
    track[t].count = 2;
    track[t].count2 = track[t].count;
   ...
   case T_DRIFTER1: etype = ENEMY_DRIFTER1;
    ...
    make_group_track(t, etype);
    break;
   case T_DRIFTER2: etype = ENEMY_DRIFTER2;
    track[t].type = etype;
    track[t].multiple = 2;
    track[t].count = 2;
    track[t].count2 = track[t].count;
   ...
   case T_MEGA: etype = ENEMY_MEGA;
    ...
    make_group_track(t, etype);
    break;
   case T_WINGS: etype = ENEMY_WINGS;
    track[t].type = etype;
    track[t].multiple = 2;
    track[t].count = 2;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_WINGS2: etype = ENEMY_WINGS2;
    track[t].type = etype;
    track[t].multiple = 2;
    track[t].count = 2;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_SMALL: etype = ENEMY_SMALL;
    track[t].type = etype;
    track[t].multiple = 3;
    track[t].count = 30;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_SMALL2: etype = ENEMY_SMALL2;
    track[t].type = etype;
    track[t].multiple = 3;
    track[t].count = 25;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_LARGER: etype = ENEMY_LARGER;
    track[t].type = etype;
    track[t].multiple = 2;
    track[t].count = 5;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_LARGER2: etype = ENEMY_LARGER2;
    track[t].type = etype;
    track[t].multiple = 2;
    track[t].count = 5;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_SWOOPER1: etype = ENEMY_SWOOPER1;
    track[t].type = etype;
    track[t].multiple = 4;
    track[t].count = 20;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_SWOOPER2: etype = ENEMY_SWOOPER2;
    track[t].type = etype;
    track[t].multiple = 4;
    track[t].count = 15;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_DARTER1: etype = ENEMY_DARTER1;
    track[t].type = etype;
    track[t].multiple = 4;
    track[t].count = 0;//20;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_DARTER2: etype = ENEMY_DARTER2;
    track[t].type = etype;
    track[t].multiple = 3;
    track[t].count = 0;//20;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_STOPPER1: etype = ENEMY_STOPPER1;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 0;//20;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_CARRIER1: etype = ENEMY_CARRIER1;
    track[t].type = etype;
    track[t].multiple = 1;
    track[t].count = 0;//20;
    track[t].count2 = track[t].count;
    ...
    make_group_track(t, etype);
    break;
   case T_DIVER1: etype = ENEMY_DIVER1;
    track[t].type = etype;
    track[t].multiple = 3;
    track[t].count = 0;//20;
    track[t].count2 = track[t].count;
   ...
   case T_RING:
    ...
    make_group_track(t, etype);
    break;
   case T_HUNTER: etype = ENEMY_HUNTER;
    track[t].type = etype;
    track[t].multiple = 2;
...
void set_dart_stopper(int e, int t, int m)
{
 ...
 {
  default:
  case ENEMY_LARGER: enemy[e].status = 16; break;
  case ENEMY_LARGER2: enemy[e].status = 12; break;
 }
 if (m % 2 == 0)
 {
  enemy[e].x = 690000;
...
// enemy [e].target = 0;
 ...
 switch(enemy[e].type)
 {
  ...
  case ENEMY_CARRIER1:
   ...
   enemy[e].angle1_turning = 0;
   enemy[e].angle1 = - ANGLE_4;
   se = create_part(e, 0, ENEMY_CARRIER1_PART, enemy[e].x - 55000, enemy[e].y - 1000);
   if (se != -1)
   {
    enemy[se].persist = 1;
    enemy[se].target = 0;
   ...
   se = create_part(e, 1, ENEMY_CARRIER1_PART, enemy[e].x + 55000, enemy[e].y - 1000);
   if (se != -1)
   {
    enemy[se].persist = 1;
    enemy[se].target = 0;

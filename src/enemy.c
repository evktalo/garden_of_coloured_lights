...
int fire_wing_diamond (int x, int y, int angle, int colour, int speed,
		       int wait);
...
int fire_dot (int x, int y, int angle, int colour, int size, int speed,
	      int wait);
int fire_beam (int e, int dist);
int fire_beam2 (int e, int angle, int dist, int time);
int fire_curve (int x, int y, int angle, int colour, int speed, int rot,
		int wait);
...
void arrange_boss3 (int speed1, int out1, int speed2, int out2, int speed3,
		    int out3);
...
void run_boss1 (int e)
{
  ...
  if (boss.phase_count <= 0)
  {
    ...
    case 1:
      ...
      break;
    case 2:
      if (boss.hp > (boss.max_hp / 4) * 3 || grand (4) == 0)
	boss.phase = 3;
      else
      {
...
void boss1_attack1 (int e, int stat)
{
  ...
  case 0:
    ...
    {
      angle += ANGLE_32;
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3, 80,
		 50 + abs (xpart (angle * 2, 30)));
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle + ANGLE_64,
		 EBCOL_B5, 100,
		 30 + abs (xpart ((angle + ANGLE_64) * 2, 10)));
    }
    boss.status = 1;
    break;
  case 1:
    ...
    for (i = 0; i < 32; i++)
    {
      ...
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3, 80,
		 50 + ypart (angle * 2 + angle1, 30));
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle + ANGLE_64,
		 EBCOL_B5, 100,
		 30 + abs (ypart ((angle + ANGLE_64) * 2 + angle1, 10)));
    }
    boss.status = grand (4);
    break;
  case 2:
    ...
    for (i = 0; i < 32; i++)
    {
      ...
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3, 80,
		 50 + ypart (angle * 2 + angle1,
			     15) + abs (xpart (angle * 4, 15)));
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle + ANGLE_64,
		 EBCOL_B5, 100,
		 30 + abs (ypart ((angle + ANGLE_64) * 2 + angle1 * 4, 10)) +
		 abs (xpart (angle * 4, 10)));
    }
    boss.status = grand (4);
    break;
  case 3:
    ...
    for (i = 0; i < 32; i++)
    {
      ...
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3, 80,
		 50 + ypart (angle * 2 + angle1,
			     10) + abs (xpart (angle * xa, 25)));
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle + ANGLE_64,
		 EBCOL_B5, 100,
		 30 + abs (ypart ((angle + ANGLE_64) * 2 + angle1 * 4, 5)) +
		 abs (xpart (angle * xa, 15)));
    }
    boss.status = grand (4);
    break;
...
void boss1_attack2 (int e, int stat)
{
  ...
  {
    fire_dart (enemy[e].x + xpart (angle, 19000),
	       enemy[e].y + ypart (angle, 19000), angle, EBCOL_B5, 80,
	       60 + i * 20);
    angle += ANGLE_3;
    fire_dart (enemy[e].x + xpart (angle, 19000),
	       enemy[e].y + ypart (angle, 19000), angle, EBCOL_B5, 80,
...
void boss1_attack3 (int e, int stat)
{
  ...
  case 0:
    ...
    {
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle, EBCOL_B4, 80, 30);
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle, EBCOL_B4, 80, 80);
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle + ANGLE_32,
		 EBCOL_B4, 80, 45);
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle - ANGLE_32,
		 EBCOL_B4, 80, 45);
      ...
      fire_dart (enemy[e].x + xpart (angle, 19000),
		 enemy[e].y + ypart (angle, 19000), angle - ANGLE_64,
		 EBCOL_B4, 80, 65);
      fire_diamond (enemy[e].x + xpart (angle, 19000),
		    enemy[e].y + ypart (angle, 19000), angle, EBCOL_B5, 1600,
		    0, 80);
  ...
  case 1:
	...
	if ((i & 4) ^ (i & 5))
	  fire_dart (enemy[e].x + xpart (angle, 19000),
		     enemy[e].y + ypart (angle, 19000), angle, EBCOL_B5, 60,
		     60 + xpart (i * 8, 40));
	else
	  fire_dart (enemy[e].x + xpart (angle, 19000),
		     enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3, 60,
		     45 + xpart (i * 8, 20));
	angle += ANGLE_64;
      }
    }
  ...
  case 3:
    if (arena.difficulty == 2)
    {
      ...
      {
	fire_diamond (enemy[e].x + xpart (angle, 19000),
		      enemy[e].y + ypart (angle, 19000), angle, EBCOL_B2,
		      2200 + xpart (i * 25, 600), xpart (i * 25, 8), 80);
	fire_diamond (enemy[e].x + xpart (angle, 19000),
		      enemy[e].y + ypart (angle, 19000), angle + ANGLE_1 / 51,
		      EBCOL_B1, 2000 + xpart (i * 25, 600),
		      xpart (i * 25 + ANGLE_2, 12), 40);
	fire_diamond (enemy[e].x + xpart (angle, 19000),
		      enemy[e].y + ypart (angle, 19000), angle + ANGLE_1 / 51,
		      EBCOL_B1, 2400 + xpart (i * 25, 600),
		      xpart (i * 25 + ANGLE_2, 12), 40);
	angle += ANGLE_1 / 20;
      }
    }
	...
	fire_diamond (enemy[e].x + xpart (angle, 19000),
		      enemy[e].y + ypart (angle, 19000), angle, EBCOL_B2,
		      2200 + xpart (i * 21, 600), xpart (i * 21, 8), 80);
	fire_diamond (enemy[e].x + xpart (angle, 19000),
		      enemy[e].y + ypart (angle, 19000), angle + ANGLE_1 / 21,
		      EBCOL_B1, 2000 + xpart (i * 21, 600),
		      xpart (i * 21 + ANGLE_2, 12), 40);
	fire_diamond (enemy[e].x + xpart (angle, 19000),
		      enemy[e].y + ypart (angle, 19000), angle + ANGLE_1 / 21,
		      EBCOL_B1, 2400 + xpart (i * 21, 600),
		      xpart (i * 21 + ANGLE_2, 12), 40);
	angle += ANGLE_1 / 12;
      }
...
void boss1_turrets (int e, int fire)
{
  ...
  if (boss.hp < boss.max_hp / 3)
  {
	...
	if (firing == 0)
	{
	  ...
	  fire_dart (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[0], 13000),
		     enemy[e].y + ypart (boss.t_angle[0], 13000),
		     boss.t_angle[0], EBCOL_B2, 50,
		     60 + arena.difficulty * 20);
	  fire_dart (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[1], 13000),
		     enemy[e].y + ypart (boss.t_angle[1], 13000),
		     boss.t_angle[1], EBCOL_B2, 50,
		     60 + arena.difficulty * 20);

	  fire_dart (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[0] + ANGLE_2, 13000),
		     enemy[e].y + ypart (boss.t_angle[0] + ANGLE_2, 13000),
		     boss.t_angle[0] + ANGLE_2, EBCOL_B2, 50,
		     60 + arena.difficulty * 20);
	  fire_dart (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[1] + ANGLE_2, 13000),
		     enemy[e].y + ypart (boss.t_angle[1] + ANGLE_2, 13000),
		     boss.t_angle[1] + ANGLE_2, EBCOL_B2, 50,
		     60 + arena.difficulty * 20);
/*             fire_diamond(enemy[e].x - 71000 - boss.out_sides2 * 1000 + xpart(boss.t_angle [0], 13000), enemy[e].y + ypart(boss.t_angle [0], 13000), boss.t_angle [0], EBCOL_B2, 1900 + arena.difficulty * 300, 0, 50);
	...
	else
	{
	  fire_dart (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[1], 13000),
		     enemy[e].y + ypart (boss.t_angle[1], 13000),
		     boss.t_angle[1], EBCOL_B1, 50,
		     40 + arena.difficulty * 15);
	  fire_dart (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[0], 13000),
		     enemy[e].y + ypart (boss.t_angle[0], 13000),
		     boss.t_angle[0], EBCOL_B1, 50,
		     40 + arena.difficulty * 15);

	  fire_dart (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[1] + ANGLE_2, 13000),
		     enemy[e].y + ypart (boss.t_angle[1] + ANGLE_2, 13000),
		     boss.t_angle[1] + ANGLE_2, EBCOL_B1, 50,
		     40 + arena.difficulty * 15);
	  fire_dart (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
		     xpart (boss.t_angle[0] + ANGLE_2, 13000),
		     enemy[e].y + ypart (boss.t_angle[0] + ANGLE_2, 13000),
		     boss.t_angle[0] + ANGLE_2, EBCOL_B1, 50,
		     40 + arena.difficulty * 15);
/*               fire_diamond(enemy[e].x + 71000 + boss.out_sides2 * 1000 + xpart(boss.t_angle [1], 13000), enemy[e].y + ypart(boss.t_angle [1], 13000), boss.t_angle [1], EBCOL_B1, 1300 + arena.difficulty * 250, 0, 50);
  ...
  for (i = 0; i < 2; i++)
  {
	...
	radians_to_angle (atan2
			  ((player.y - enemy[e].y),
			   (player.x -
			    (enemy[e].x - 71000 - boss.out_sides2 * 1000))));
    }
    else
      tangle =
	radians_to_angle (atan2
  ...
  if (boss.t_recycle[0] <= 0)
  {
	...
	if (firing == 0)
	{
	  fire_diamond (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
			xpart (boss.t_angle[0], 13000),
			enemy[e].y + ypart (boss.t_angle[0], 13000),
			boss.t_angle[0], EBCOL_B2,
			1700 + arena.difficulty * 300, 0, 50);
	  fire_diamond (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
			xpart (boss.t_angle[0], 13000),
			enemy[e].y + ypart (boss.t_angle[0], 13000),
			boss.t_angle[0] - ANGLE_32, EBCOL_B2,
			1600 + arena.difficulty * 250, -8, 50);
	  fire_diamond (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
			xpart (boss.t_angle[0], 13000),
			enemy[e].y + ypart (boss.t_angle[0], 13000),
			boss.t_angle[0] + ANGLE_32, EBCOL_B2,
	...
	else
	{
	  fire_diamond (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
			xpart (boss.t_angle[1], 13000),
			enemy[e].y + ypart (boss.t_angle[1], 13000),
			boss.t_angle[1], EBCOL_B2,
			1700 + arena.difficulty * 300, 0, 50);
	  fire_diamond (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
			xpart (boss.t_angle[1], 13000),
			enemy[e].y + ypart (boss.t_angle[1], 13000),
			boss.t_angle[1] - ANGLE_32, EBCOL_B2,
			1600 + arena.difficulty * 250, 8, 50);
	  fire_diamond (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
			xpart (boss.t_angle[1], 13000),
			enemy[e].y + ypart (boss.t_angle[1], 13000),
	...
	fire_dart (enemy[e].x - 71000 - boss.out_sides2 * 1000 +
		   xpart (boss.t_angle[0], 13000),
		   enemy[e].y + ypart (boss.t_angle[0], 13000),
		   boss.t_angle[0], EBCOL_B1, 50, 80 + arena.difficulty * 10);
      else
	fire_dart (enemy[e].x + 71000 + boss.out_sides2 * 1000 +
		   xpart (boss.t_angle[1], 13000),
		   enemy[e].y + ypart (boss.t_angle[1], 13000),
		   boss.t_angle[1], EBCOL_B1, 50, 80 + arena.difficulty * 10);
      boss.t_recycle[0] = 20 - arena.difficulty * 5;
      return;
    }
  }
...
void run_boss2 (int e)
{
  ...
  quick_cloud (CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 74000,
	       enemy[e].x_speed + grand (500) - grand (500),
	       enemy[e].y_speed + 3500 + grand (2500), 8 + grand (8),
	       TCOL_ORANGE, 0);
  quick_cloud (CLOUD_CIRCLE1, enemy[e].x, enemy[e].y + 85000,
	       enemy[e].x_speed + grand (500) - grand (500),
	       enemy[e].y_speed + 3500 + grand (2500), 17 + grand (17),
	       TCOL_SH2, 0);
  ...
  if (boss.phase > 1)
  {
	...
	&& (enemy[e].x < 80000
	    || enemy[e].x > 560000
	    || enemy[e].y < 80000 || enemy[e].y > 350000))
    {
      enemy[e].x_target[0] = 150000 + grand (390000);
      enemy[e].y_target[0] = 120000 + grand (80000);
      enemy[e].angle =
...
void boss2_attack1 (int e, int stat)
{
  ...
  case 0:
    ...
    for (i = 0; i < 32; i++)
    {
      angle += ANGLE_32;
      angle1 += ANGLE_32;
      fire_dot (enemy[e].x + xpart (angle, 19000),
		enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3, 9,
		3000 + xpart (angle1 * 6, 1000), 7);
...
//    fire_dot(enemy[e].x + xpart(angle, 40000), enemy[e].y + ypart(angle, 30000), angle, EBCOL_B2, 3, 3000 + xpart(angle * 8, 1000), 7);
      fire_dot (enemy[e].x + xpart (angle, 1000),
		enemy[e].y + ypart (angle, 1000), angle, EBCOL_B3, 4,
		3000 + xpart (angle1 * 6, 1000), 7);
    }
    boss.status = 1;
    break;
  case 1:
    ...
    for (i = 0; i < 32; i++)
    {
      ...
      angle1 += ANGLE_32;
      fire_dot (enemy[e].x + xpart (angle, 19000),
		enemy[e].y + ypart (angle, 19000), angle, EBCOL_B2, 9,
		2000 + xpart (angle1 * 6, 600), 7);
      fire_dot (enemy[e].x + xpart (angle, 1000),
		enemy[e].y + ypart (angle, 1000), angle, EBCOL_B2, 4,
		2000 + xpart (angle1 * 6, 600), 7);
    }
    boss.status = 2;
    break;
  case 2:
    ...
    for (i = 0; i < 32; i++)
    {
      ...
      angle1 += ANGLE_32;
      fire_dot (enemy[e].x + xpart (angle, 19000),
		enemy[e].y + ypart (angle, 19000), angle, EBCOL_B1, 9,
		1000 + xpart (angle1 * 6, 300), 7);
      fire_dot (enemy[e].x + xpart (angle, 1000),
		enemy[e].y + ypart (angle, 1000), angle, EBCOL_B1, 4,
		1000 + xpart (angle1 * 6, 300), 7);
    }
    boss.status = 2;
    break;
...
void boss2_attack2 (int e, int stat)
{
  ...
  for (j = 0; j < 5; j++)
  {
    ...
    {
      fire_dot (enemy[e].x + xpart (angle, i * 11000),
		enemy[e].y + ypart (angle, i * 11000), angle, EBCOL_B5, 7,
		2000 + i * 400, 7);
      if (i > 0)
      {
	if (i & 1)
	  fire_dot (enemy[e].x + xpart (angle, i * 11000) +
		    xpart (angle - ANGLE_3, 19000), enemy[e].y + ypart (angle,
									i *
									11000)
		    + ypart (angle - ANGLE_3, 19000), angle, EBCOL_B3, 4,
		    1800 + i * 400, 1);
	else
	  fire_dot (enemy[e].x + xpart (angle, i * 11000) +
		    xpart (angle + ANGLE_3, 19000), enemy[e].y + ypart (angle,
...
void boss2_attack3 (int e, int stat)
{
  ...
  case 0:
    ...
    for (i = 0; i < 48; i++)
    {
      ...
      angle1 += ANGLE_48;
      fire_dot (enemy[e].x + xpart (angle, 19000),
		enemy[e].y + ypart (angle, 19000), angle, EBCOL_B3,
		B2_SIZE1 + xpart (angle1 * 4, B2_SIZE2), 4000, 7);
    }
    boss.status = 1;
    break;
  case 1:
    ...
    for (i = 0; i < 48; i++)
    {
      ...
      fire_dot (enemy[e].x + xpart (angle, 19000),
		enemy[e].y + ypart (angle, 19000), angle, EBCOL_B2,
		B2_SIZE1 + xpart (angle1 * 4, B2_SIZE2), 3000, 7);
    }
    boss.status = 2;
    break;
  case 2:
    ...
    for (i = 0; i < 48; i++)
    {
      ...
      angle1 += ANGLE_96;
      fire_dot (enemy[e].x + xpart (angle, 19000),
		enemy[e].y + ypart (angle, 19000), angle, EBCOL_B1,
		B2_SIZE1 + xpart (angle1 * 4, B2_SIZE2), 2000, 7);
    }
    boss.status = 2;
    break;
  }
...
void boss2_attack4 (int e, int stat)
{
  ...
  {
    angle = grand (ANGLE_1);
    fire_dot (enemy[e].x + xpart (angle, 3000),
	      enemy[e].y + ypart (angle, 3000), angle, EBCOL_B1 + grand (3),
	      5 + grand (3), 2000 + grand (3000), 2 + grand (7));
  }
...
void boss2_turrets (int e, int fire)
{
  ...
  if (boss.t_recycle[0] <= 0)
  {
	...
	which = 2;
      ...
      default:
	synch_done[DONE_FIRE2_1] |= FIRE2_DRIFTER1;
	fire_dot (x + xpart (a, 15000), y + ypart (a, 15000), a, EBCOL_B5, 8,
		  4000, 0);
...
int boss2_beam (int e, int dist, int x1, int y1, int angle, int stat)
{
  ...
  do
  {
    ...
    x += xpart (angle, 45000);
    y += ypart (angle, 45000);
    if (x > 690000 || x < -50000 || y > 530000 || y < -50000)
      break;
  }
  while (TRUE);
...
void boss3_attack1 (int e, int stat)
{
  ...
  for (i = 0; i < 8; i++)
  {
    angle1 += ANGLE_16;
    angle1 &= 1023;
    fire_dart (enemy[e].x + xpart (angle, 9000),
	       enemy[e].y + ypart (angle, 9000), angle, EBCOL_B3, 80,
	       50 + xpart (angle1, 5 + boss.status));
    angle += ANGLE_2;
    fire_dart (enemy[e].x + xpart (angle, 9000),
	       enemy[e].y + ypart (angle, 9000), angle, EBCOL_B5, 80,
	       50 + xpart (angle1, 5 + boss.status));
    angle -= ANGLE_2;
    angle += ANGLE_32;
    angle &= 1023;
...
void boss3_attack2 (int e, int stat)
{
  ...
  for (i = 0; i < 5; i++)
  {
    fire_ddart (enemy[e].x + xpart (angle, 9000),
		enemy[e].y + ypart (angle, 9000), angle, EBCOL_B5, 60, 90);
    fire_dart (enemy[e].x + xpart (angle, 9000),
	       enemy[e].y + ypart (angle, 9000), angle + ANGLE_32, EBCOL_B4,
	       50, 80);
    fire_dart (enemy[e].x + xpart (angle, 9000),
	       enemy[e].y + ypart (angle, 9000), angle - ANGLE_32, EBCOL_B4,
	       50, 80);
    fire_sdart (enemy[e].x + xpart (angle, 9000),
		enemy[e].y + ypart (angle, 9000), angle + ANGLE_16, EBCOL_B3,
		40, 70);
    fire_sdart (enemy[e].x + xpart (angle, 9000),
		enemy[e].y + ypart (angle, 9000), angle - ANGLE_16, EBCOL_B3,
		40, 70);
...
// if (boss.status
  ...
  for (i = 0; i < 4; i++)
  {
    ...
    if (arena.difficulty > 0)
      fire_ddart (enemy[e].x + xpart (angle1, 9000),
		  enemy[e].y + ypart (angle1, 9000), angle1, EBCOL_B5, 50,
		  90);
    angle1 += ANGLE_16;
    fire_dart (enemy[e].x + xpart (angle1, 9000),
	       enemy[e].y + ypart (angle1, 9000), angle1, EBCOL_B4, 50, 80);
    angle1 += ANGLE_16;
    fire_sdart (enemy[e].x + xpart (angle1, 9000),
		enemy[e].y + ypart (angle1, 9000), angle1, EBCOL_B3, 40, 70);
    angle += ANGLE_4;
    angle &= 1023;
  }
...
void boss3_attack4 (int e, int stat)
{
  ...
  {
    angle = grand (ANGLE_1);
    fire_seed2 (enemy[e].x + xpart (angle, 9000),
		enemy[e].y + ypart (angle, 9000), grand (ANGLE_1), EBCOL_B5,
		18 + grand (20), 2000 + grand (2500));
  }
...
void boss3_finish_firing (int e)
{
  ...
  if (boss.phase2 <= 0)
  {
    ...
    if (enemy[e].x <= 320000 && enemy[e].y > 100000)
      enemy[e].angle =
	ANGLE_2 + ANGLE_4 + ANGLE_8 + ANGLE_16 + grand (ANGLE_16);
    if (enemy[e].x > 320000 && enemy[e].y > 100000)
...
//       ebullet[b].status = 100;
  ...
  for (i = 0; i < 3; i++)
  {
    ...
    if (b != -1)
    {
      ...
      ebullet[b].y =
	enemy[e].y + 25000 + ypart (angle, boss.spin_rad2 * GRAIN);
...
void boss4_outer_fire (int e)
{
  ...
  case 0:
    if (synch_ready[EVENT_FIRE4_2])
    {
      ...
      for (i = 0; i < 6; i++)
      {
	fire_dart (enemy[e].x - 70000 + xpart (angle, 10000),
		   enemy[e].y - 61000 + ypart (angle, 10000), angle, EBCOL_B2,
		   50, 90);
	fire_curve (enemy[e].x - 70000 + xpart (angle, 10000),
		    enemy[e].y - 61000 + ypart (angle, 10000),
		    angle + ANGLE_12 / 2, EBCOL_B3, 3000, xpart (angle * 2,
								 8), 5);
	angle += ANGLE_2;
	fire_dart (enemy[e].x + 70000 + xpart (angle, 10000),
		   enemy[e].y - 61000 + ypart (angle, 10000), angle, EBCOL_B2,
  ...
  case 1:
    if (synch_ready[EVENT_FIRE4_1])
    {
      ...
      fire_curve (enemy[e].x - 70000 + xpart (angle, 10000),
		  enemy[e].y - 61000 + ypart (angle, 10000), angle, EBCOL_B1,
		  3000, i, 5);
      i *= -1;
      fire_curve (enemy[e].x + 70000 + xpart (angle, 10000),
		  enemy[e].y - 61000 + ypart (angle, 10000), angle, EBCOL_B1,
...
void boss4_sides_fire (int e)
{
  ...
  if (boss.hp < (boss.max_hp / 3))
  {
    if (synch_ready[EVENT_FIRE4_2])
    {
      ...
      fire_tracker (enemy[e].x - 77000, enemy[e].y - 8000, ANGLE_2 + ANGLE_64,
		    EBCOL_B2, 4, 500);
      fire_tracker (enemy[e].x - 80000, enemy[e].y + 24000,
		    ANGLE_2 - ANGLE_32, EBCOL_B2, 4, 500);
      fire_tracker (enemy[e].x - 68000, enemy[e].y + 50000,
		    ANGLE_2 - ANGLE_16, EBCOL_B2, 4, 500);
      fire_tracker (enemy[e].x - 45000, enemy[e].y + 70000, ANGLE_2 - ANGLE_8,
		    EBCOL_B2, 4, 500);


      fire_tracker (enemy[e].x + 77000, enemy[e].y - 8000, ANGLE_1 - ANGLE_64,
		    EBCOL_B2, 4, 500);
      fire_tracker (enemy[e].x + 80000, enemy[e].y + 24000, ANGLE_32,
		    EBCOL_B2, 4, 500);
      fire_tracker (enemy[e].x + 68000, enemy[e].y + 50000, ANGLE_16,
		    EBCOL_B2, 4, 500);
      fire_tracker (enemy[e].x + 45000, enemy[e].y + 70000, ANGLE_8, EBCOL_B2,
		    4, 500);
  ...
  if (boss.hp < (boss.max_hp / 3) * 2)
  {
    if (synch_ready[EVENT_FIRE4_1])
    {
      ...
      fire_ddart (enemy[e].x - 77000, enemy[e].y - 8000, angle - 60, EBCOL_B2,
		  70, 80);
      fire_ddart (enemy[e].x - 80000, enemy[e].y + 24000, angle - 40,
		  EBCOL_B2, 70, 77);
      fire_ddart (enemy[e].x - 68000, enemy[e].y + 50000, angle - 20,
		  EBCOL_B2, 70, 74);
      fire_ddart (enemy[e].x - 45000, enemy[e].y + 70000, angle, EBCOL_B2, 70,
		  70);
  ...
  if (synch_ready[EVENT_FIRE4_1])
  {
    ...
    fire_dart (enemy[e].x - 77000, enemy[e].y - 8000, angle + 60, EBCOL_B5,
	       70, 50);
    fire_dart (enemy[e].x - 80000, enemy[e].y + 24000, angle + 40, EBCOL_B5,
	       70, 50);
    fire_dart (enemy[e].x - 68000, enemy[e].y + 50000, angle + 20, EBCOL_B5,
	       70, 50);
    fire_dart (enemy[e].x - 45000, enemy[e].y + 70000, angle, EBCOL_B5, 70,
	       50);
    angle = ANGLE_1 - angle + ANGLE_2;
...
//       petal_turn(e, 2, enemy[e].angle1 + ANGLE_3, 2, 8);
  ...
  case ENEMY_SMALL2:
    if (ready_to_fire)
    {
      if (synch_ready[EVENT_FIRE3_2])
      {
	fire_dart (enemy[e].x, enemy[e].y, attack_angle (e), EBCOL_B4, 30,
		   110 + arena.difficulty * 10);
...
//       petal_turn(e, 2, enemy[e].angle1 + ANGLE_3, 2, 8);
  ...
  case ENEMY_HOOK:
    if (ready_to_fire)
    {
      if (synch_ready[EVENT_FIRE4_1])
      {
	fire_curve (enemy[e].x - 8000, enemy[e].y, attack_angle (e), EBCOL_B2,
		    4000, pos_or_neg (3 + grand (4)), 2);
	fire_curve (enemy[e].x + 8000, enemy[e].y, attack_angle (e), EBCOL_B2,
		    4000, pos_or_neg (3 + grand (4)), 2);
	enemy[e].recycle = 160 - arena.difficulty * 30;
	synch_done[DONE_FIRE4_1] |= FIRE4_HOOK;
  ...
  case ENEMY_HOOK2:
    if (ready_to_fire)
    {
      if (synch_ready[EVENT_FIRE4_1])
      {
	fire_curve (enemy[e].x - 11000, enemy[e].y, attack_angle (e),
		    EBCOL_B5, 4600, pos_or_neg (5 + grand (4)), 2);
	fire_curve (enemy[e].x + 11000, enemy[e].y, attack_angle (e),
		    EBCOL_B5, 4600, pos_or_neg (5 + grand (4)), 2);
...
void petal_turn (int e, int p, int target_angle, int accel, int max_speed)
{
  ...
  if ((enemy[e].petal_angle[p] < target_angle
...
void move_darter (int e)
{
  ...
  case 2:			// shooting
	...
	if (synch_ready[EVENT_SWOOPER1_FIRE])
	{
	  ...
	  fire_dart (enemy[e].x + xpart (enemy[e].angle1, 7000),
		     enemy[e].y + ypart (enemy[e].angle1, 7000),
		     enemy[e].angle1, EBCOL_B3, 50,
		     80 + arena.difficulty * 10);
	...
	if (synch_ready[EVENT_SWOOPER1_FIRE])
	{
	  ...
	  fire_dart (enemy[e].x + xpart (enemy[e].angle1, 7000),
		     enemy[e].y + ypart (enemy[e].angle1, 7000),
		     enemy[e].angle1, EBCOL_B4, 50,
		     90 + arena.difficulty * 15);
	  fire_dart (enemy[e].x + xpart (enemy[e].angle1, 7000),
		     enemy[e].y + ypart (enemy[e].angle1, 7000),
		     enemy[e].angle1 - ANGLE_32, EBCOL_B5, 50,
		     80 + arena.difficulty * 10);
	  fire_dart (enemy[e].x + xpart (enemy[e].angle1, 7000),
		     enemy[e].y + ypart (enemy[e].angle1, 7000),
		     enemy[e].angle1 + ANGLE_32, EBCOL_B5, 50,
...
//           fire_wing_diamond(enemy[e].x, enemy[e].y, attack_angle(e), EBCOL_B2, 20, 40);
	...
	if ((enemy[e].petal_angle[i] > tangle - 20
	    ...
	    || (tangle > ANGLE_1 - 20
		&& enemy[e].petal_angle[i] < ANGLE_1 - tangle))
	{
...
//           fire_seed(enemy[e].x, enemy[e].y, attack_angle(e), EBCOL_B5, 18 + grand(10), 2000 + grand(1500));
	  fire_seed (enemy[e].x, enemy[e].y, grand (ANGLE_1), EBCOL_B5,
		     18 + grand (10), 2000 + grand (1500));
	  if (arena.difficulty > 0)
	    fire_seed (enemy[e].x, enemy[e].y, grand (ANGLE_1), EBCOL_B5,
		       18 + grand (10), 2000 + grand (1500));
	  if (arena.difficulty > 1)
...
void move_drifter (int e)
{
  ...
  case 0:
	...
	|| (enemy[e].escorting != -1 && (enemy[e].target_time & 16) == 1))
    {
      ...
      {
	enemy[e].x_target[0] =
	  enemy[enemy[e].escorting].x + grand (60000) - grand (60000) +
	  enemy[e].pulse1;
	enemy[e].y_target[0] =
	  enemy[enemy[e].escorting].y + grand (60000) - grand (60000) +
	  enemy[e].pulse2;
	enemy[e].angle =
	  get_e_angle (e, enemy[e].x_target[0], enemy[e].y_target[0]);
      }
...
/ *       if (enemy[e].status == 100)
  ...
  case ENEMY_ESCORT:
	...
	synch_done[DONE_FIRE2_1] |= FIRE2_DRIFTER1;
	angle = attack_angle (e);
	fire_dot (enemy[e].x, enemy[e].y, angle, EBCOL_B3, 5,
		  4000 + arena.difficulty * 1000, 7);
	enemy[e].recycle = 65 - arena.difficulty * 10;
	enemy[e].status = 16;
      }
    }
    quick_cloud (CLOUD_CIRCLE2, enemy[e].x,
		 enemy[e].y + 15000 + (enemy[e].type ==
				       ENEMY_DRIFTER1) * 4000,
		 enemy[e].x_speed + grand (300) - grand (300),
		 enemy[e].y_speed + 1500 + grand (2500), 6 + grand (4),
		 TCOL_SH2, 0);
    break;
  case ENEMY_DRIFTER2:
    quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 4000, enemy[e].y + 17000,
		 enemy[e].x_speed + grand (300) - grand (300),
		 enemy[e].y_speed + 1500 + grand (2500), 6 + grand (4),
		 TCOL_SH2, 0);
    quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 4000, enemy[e].y + 17000,
    ...
    if (enemy[e].status > 0)
      enemy[e].status--;
    if (enemy[e].recycle <= 0 && enemy[e].phase == 0)
    {
      if (synch_ready[EVENT_FIRE2_1])
      {
	synch_done[DONE_FIRE2_1] |= FIRE2_DRIFTER1;
	angle = attack_angle (e);
	fire_dot (enemy[e].x, enemy[e].y, angle, EBCOL_B4, 6,
		  4000 + arena.difficulty * 1000, 8);
	fire_dot (enemy[e].x, enemy[e].y, angle - ANGLE_32, EBCOL_B3, 4,
		  3700 + arena.difficulty * 1000, 6);
	fire_dot (enemy[e].x, enemy[e].y, angle + ANGLE_32, EBCOL_B3, 4,
		  3700 + arena.difficulty * 1000, 6);
...
//        fire_curve(x, y, angle + ANGLE_12 / 2, EBCOL_B3, 3000, pos_or_neg(3 + grand(4)), 5);
	fire_curve (x, y, angle + ANGLE_12 / 2, EBCOL_B3, 3000,
		    xpart (angle * 2, 8), 5);
	angle += ANGLE_12;
	angle &= 1023;
      }
...
void move_cruiser (int e)
{
  ...
  case ENEMY_SPINNER:
	...
	angle =
	  radians_to_angle (atan2
			    (player.y - enemy[e].y - 32000,
			     player.x - enemy[e].x));
	fire_ddart (enemy[e].x, enemy[e].y + 32000, angle, EBCOL_B5, 40,
		    90 + arena.difficulty * 10);
	angle =
	  radians_to_angle (atan2
			    (player.y - enemy[e].y + 32000,
			     player.x - enemy[e].x));
  ...
  case ENEMY_DROPPER:
	...
	for (i = 0; i < 3; i++)
	{
	  ...
	  fire_dart (enemy[e].x - 7000, enemy[e].y + 14000, angle + ANGLE_2,
		     EBCOL_B1, 50, 70 + grand (30));
	  fire_dart (enemy[e].x + 7000, enemy[e].y + 14000, angle, EBCOL_B1,
		     50, 70 + grand (30));
  ...
  case ENEMY_CRUISER4:
    if ((arena.counter & 1) == 0)
    {
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 14000, enemy[e].y + 49000,
		   grand (300) - grand (300), 3500 + grand (2500),
		   6 + grand (6), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 14000, enemy[e].y + 49000,
		   grand (300) - grand (300), 3500 + grand (2500),
		   6 + grand (6), TCOL_ORANGE, 0);
    }
...
/*         enemy[e].status = 40;
  ...
  case ENEMY_CRUISER3:
    if ((arena.counter & 1) == 0)
    {
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 47000, enemy[e].y + 64000,
		   grand (300) - grand (300), 3500 + grand (2500),
		   9 + grand (9), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 47000, enemy[e].y + 64000,
		   grand (300) - grand (300), 3500 + grand (2500),
		   9 + grand (9), TCOL_ORANGE, 0);
    }
	...
	for (i = 0; i < 6; i++)
	{
	  ...
	  angle &= 1023;
	  b =
	    fire_dot (enemy[e].x + xpart (enemy[e].angle1, 23000),
		      enemy[e].y + ypart (enemy[e].angle1, 23000),
		      enemy[e].angle1, EBCOL_B3, 4 + i, 2500, 0);
	  if (b != -1)
	  {
	...
	for (i = 0; i < 8; i++)
	{
	  ...
	  b =
	    fire_dot (enemy[e].x + xpart (enemy[e].angle1, 23000),
		      enemy[e].y + ypart (enemy[e].angle1, 23000),
		      enemy[e].angle1, EBCOL_B2, 12 - i, 2500, 0);
	  if (b != -1)
	  {
	...
	for (i = 0; i < 16; i++)
	{
	  ...
	  b =
	    fire_dot (enemy[e].x + xpart (enemy[e].angle1, 23000),
		      enemy[e].y + ypart (enemy[e].angle1, 23000),
		      enemy[e].angle1, EBCOL_B1, 4 + i / 4, 2500, 0);
	  if (b != -1)
	  {
	  ...
	  quick_cloud (CLOUD_MSHOCK,
		       enemy[e].x + xpart (enemy[e].angle1, 24000),
		       enemy[e].y + ypart (enemy[e].angle1, 24000),
		       enemy[e].x_speed, enemy[e].y_speed, 20, 2, 0);
	  quick_cloud (CLOUD_CIRCLE2,
		       enemy[e].x + xpart (enemy[e].angle1, 24000),
		       enemy[e].y + ypart (enemy[e].angle1, 24000),
		       enemy[e].x_speed, enemy[e].y_speed, 20 + grand (5),
		       TCOL_SH1, 0);
	  quick_cloud (CLOUD_CIRCLE3,
		       enemy[e].x + xpart (enemy[e].angle1, 24000),
		       enemy[e].y + ypart (enemy[e].angle1, 24000),
		       enemy[e].x_speed, enemy[e].y_speed, 30 + grand (5),
		       TCOL_SH2, 0);
	}
      }
    }
  ...
  case ENEMY_CRUISER2:
    if ((arena.counter & 1) == 0)
    {
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 47000, enemy[e].y + 14000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   5 + grand (5), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 47000, enemy[e].y + 14000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   5 + grand (5), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 43000,
		   grand (300) - grand (300), 3000 + grand (2500),
		   7 + grand (7), TCOL_ORANGE, 0);
    }
    else
    {
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 47000, enemy[e].y + 14000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   10 + grand (10), TCOL_SH2, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 47000, enemy[e].y + 14000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   10 + grand (10), TCOL_SH2, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 43000,
		   grand (300) - grand (300), 3000 + grand (2500),
		   14 + grand (14), TCOL_SH2, 0);
    }
    track_target (e, player.x, player.y, enemy[e].angle1, 6);
	...
	{
	  b =
	    fire_dot (enemy[e].x + xpart (enemy[e].angle1, 9000),
		      enemy[e].y + ypart (enemy[e].angle1, 9000), angle,
		      EBCOL_B5, 4 + i, 1500 + (i * 600), 0);
	  if (b != -1)
	  {
	  ...
	  if ((i & 1) == 0)
	  {
	    b =
	      fire_dot (enemy[e].x + xpart (enemy[e].angle1, 9000),
			enemy[e].y + ypart (enemy[e].angle1, 9000),
			angle - ANGLE_64, EBCOL_B5, 2 + i / 2,
			1500 + (i * 550), 0);
	    if (b != -1)
	    {
	      ebullet[b].y_speed += enemy[e].y_speed;
	...
	enemy[e].recycle = 130 - arena.difficulty * 19;
	quick_cloud (CLOUD_MSHOCK,
		     enemy[e].x + xpart (enemy[e].angle1, 10000),
		     enemy[e].y + ypart (enemy[e].angle1, 10000),
		     enemy[e].x_speed, enemy[e].y_speed, 20, 0, 0);
	quick_cloud (CLOUD_CIRCLE2,
		     enemy[e].x + xpart (enemy[e].angle1, 10000),
		     enemy[e].y + ypart (enemy[e].angle1, 10000),
		     enemy[e].x_speed, enemy[e].y_speed, 20 + grand (5),
  ...
  case ENEMY_CRUISER1:
    if ((arena.counter & 1) == 0)
    {
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 42000, enemy[e].y + 61000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   5 + grand (5), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 42000, enemy[e].y + 61000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   5 + grand (5), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x + 16000, enemy[e].y + 69000,
		   grand (300) - grand (300), 3000 + grand (2000),
		   5 + grand (5), TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x - 16000, enemy[e].y + 69000,
		   grand (300) - grand (300), 3000 + grand (2000),
	...
	fire_dot (enemy[e].x + xpart (enemy[e].angle1, 6000),
		  enemy[e].y + ypart (enemy[e].angle1, 6000) - 41000,
		  enemy[e].angle1, EBCOL_B1, 4, 3000 + arena.difficulty * 700,
		  15);
	...
	for (i = 0; i < 7; i++)
	{
	  ...
	  angle &= 1023;
	  b =
	    fire_dot (enemy[e].x + xpart (enemy[e].angle, 11000),
		      enemy[e].y + ypart (enemy[e].angle, 11000), angle,
		      EBCOL_B3, 6 + grand (3),
		      1500 + arena.difficulty * 500 + grand (2500), 0);
	  if (b != -1)
	  {
	    ebullet[b].y_speed += enemy[e].y_speed;
	    ebullet[b].cord_wait = -1;
	...
	for (i = 0; i < 7; i++)
	{
	  ...
	  b =
	    fire_dot (enemy[e].x + xpart (enemy[e].angle, 11000),
		      enemy[e].y + ypart (enemy[e].angle, 11000), angle,
		      EBCOL_B2, 5 + grand (3),
		      1500 + arena.difficulty * 500 + grand (2000), 0);
	  if (b != -1)
	  {
	    ebullet[b].y_speed += enemy[e].y_speed;
	    ebullet[b].cord_wait = -1;
	...
	quick_cloud (CLOUD_MSHOCK, enemy[e].x + xpart (enemy[e].angle, 11000),
		     enemy[e].y + ypart (enemy[e].angle, 11000),
		     enemy[e].x_speed, enemy[e].y_speed, 20, 2, 0);
	quick_cloud (CLOUD_CIRCLE2,
		     enemy[e].x + xpart (enemy[e].angle, 11000),
		     enemy[e].y + ypart (enemy[e].angle, 11000),
		     enemy[e].x_speed, enemy[e].y_speed, 20 + grand (5),
		     TCOL_SH1, 0);
	quick_cloud (CLOUD_CIRCLE3,
...
//    if (enemy[e].phase2 >= 3)
  ...
  case 0:			// entering
    ...
    case ENEMY_SHOOTER:
      if ((arena.counter & 1) == 0)
      {
	quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 27000,
		     grand (300) - grand (300),
		     2000 + grand (2000) + enemy[e].y_speed, 5 + grand (5),
		     TCOL_ORANGE, 0);
      }
      else
      {
	quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 27000,
		     grand (300) - grand (300),
		     2000 + grand (2000) + enemy[e].y_speed, 10 + grand (10),
		     TCOL_SH2, 0);
      }
      break;
    }
  ...
  case 2:			// shooting
	...
	quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 27000,
		     grand (300) - grand (300),
		     2000 + grand (2000) + enemy[e].y_speed, 3 + grand (3),
		     TCOL_ORANGE, 0);
      }
      else
      {
	quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 27000,
		     grand (300) - grand (300),
		     2000 + grand (2000) + enemy[e].y_speed, 6 + grand (6),
		     TCOL_SH2, 0);
      }
	...
	quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 27000,
      ...
      track_target (e, player.x, player.y, enemy[e].angle1, 6);
      if (enemy[e].recycle <= 0
	  && enemy[e].status == 9 + arena.difficulty * 3)
      {
	if (synch_ready[EVENT_FIRE2_2] && synch_done[DONE_FIRE2_2] == 0)
	{
	...
	enemy[e].angle1 &= 1023;
	angle = enemy[e].angle1;
	fire_dot (enemy[e].x + xpart (angle, 10000),
		  enemy[e].y + ypart (angle, 10000), angle, EBCOL_B5, 4,
		  3500 + arena.difficulty * 800 + grand (500), 9);
...
//        synch_done [DONE_FIRE3_2] |= FIRE3_WINGS;
	  angle = attack_angle (e);
	  fire_dot (enemy[e].x, enemy[e].y, angle, EBCOL_B2, 5,
		    3500 + arena.difficulty * 800, 9);
...
//      quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 2000, enemy[e].y + 23000, enemy[e].x_speed + grand(300) - grand(300), enemy[e].y_speed + 1500 + grand(2500), 4 + grand(3), TCOL_SH2, 0);
	    ...
	    && (synch_done[DONE_SWOOPER1_FIRE] & FIRE1_DIVER1) == 0)
	{
	  ...
	  {
	  case 0:
	    fire_ddart (enemy[e].x - xpart (angle, 18000),
			enemy[e].y - ypart (angle, 18000), angle, EBCOL_B3,
			50, 120);
	    enemy[e].status = 1;
	    break;
	  case 1:
	    fire_dart (enemy[e].x + xpart (angle + ANGLE_4 - ANGLE_16, 16000),
		       enemy[e].y + ypart (angle + ANGLE_4 - ANGLE_16, 16000),
		       angle - ANGLE_32, EBCOL_B2, 50, 90);
	    fire_dart (enemy[e].x + xpart (angle - ANGLE_4 + ANGLE_16, 16000),
		       enemy[e].y + ypart (angle - ANGLE_4 + ANGLE_16, 16000),
		       angle + ANGLE_32, EBCOL_B2, 50, 90);
	    enemy[e].status = 2;
	    break;
	  case 2:
	    fire_dart (enemy[e].x + xpart (angle + ANGLE_4 + ANGLE_8, 16000),
		       enemy[e].y + ypart (angle + ANGLE_4 + ANGLE_8, 16000),
		       angle + ANGLE_16, EBCOL_B1, 50, 70);
	    fire_dart (enemy[e].x + xpart (angle + ANGLE_4 + ANGLE_8, 16000),
		       enemy[e].y + ypart (angle + ANGLE_4 + ANGLE_8, 16000),
		       angle - ANGLE_32, EBCOL_B1, 50, 70);
	    fire_dart (enemy[e].x + xpart (angle - ANGLE_4 - ANGLE_8, 16000),
		       enemy[e].y + ypart (angle - ANGLE_4 - ANGLE_8, 16000),
		       angle + ANGLE_32, EBCOL_B1, 50, 70);
	    fire_dart (enemy[e].x + xpart (angle - ANGLE_4 - ANGLE_8, 16000),
	...
	if (synch_ready[EVENT_STOPPER1_FIRE])
	{
	  ...
	  {
	    angle &= 1023;
	    fire_dart (enemy[e].x + xpart (angle, 24000),
		       enemy[e].y + ypart (angle, 24000), angle, EBCOL_B5, 50,
		       120);
	    angle += angle_inc;
	    angle &= 1023;
	    fire_dart (enemy[e].x + xpart (angle, 24000),
	    ...
	    if (arena.difficulty > 0)
	    {
	      ...
	      angle &= 1023;
	      fire_dart (enemy[e].x + xpart (angle, 24000),
			 enemy[e].y + ypart (angle, 24000), angle, EBCOL_B5,
			 50, 60);
	      angle += angle_inc;
	      angle &= 1023;
	      fire_dart (enemy[e].x + xpart (angle, 24000),
	...
	if ((enemy[e].angle1 < ANGLE_1 - ANGLE_4
	     && enemy[e].angle1 + enemy[e].angle1_turning >=
	     ANGLE_1 - ANGLE_4) || (enemy[e].angle1 > ANGLE_1 - ANGLE_4
				    && enemy[e].angle1 +
				    enemy[e].angle1_turning <=
				    ANGLE_1 - ANGLE_4))
	{
...
//          fire_diamond(enemy[e].x + xpart(angle, 22000), enemy[e].y + ypart(angle, 22000), angle - ANGLE_4, EBCOL_B3, 2000, -8, 50);
	    if (arena.difficulty > 0)
	      fire_diamond (enemy[e].x + xpart (angle, 22000),
			    enemy[e].y + ypart (angle, 22000),
			    angle + ANGLE_4, EBCOL_B2,
			    1700 + arena.difficulty * 50, 6, 50);
	    fire_diamond (enemy[e].x + xpart (angle, 22000),
			  enemy[e].y + ypart (angle, 22000), angle - ANGLE_4,
			  EBCOL_B3, 1800 + arena.difficulty * 150, -8, 50);
	    angle += ANGLE_3;
	    angle &= 1023;
	  }
	}
    ...
    case ENEMY_WINGS:
      ...
      {
	if (synch_ready[EVENT_FIRE3_2]
	    && (synch_done[DONE_FIRE3_2] & FIRE3_WINGS) == 0)
	{
	  synch_done[DONE_FIRE3_2] |= FIRE3_WINGS;
	  angle = attack_angle (e);
	  fire_burst (enemy[e].x, enemy[e].y - 10000, angle, EBCOL_B2,
		      1700 + arena.difficulty * 50, 30);
	  enemy[e].recycle = 40 - arena.difficulty * 10;
	}
      }
      break;
    case ENEMY_WINGS2:
      ...
      {
	if (synch_ready[EVENT_FIRE3_2]
	    && (synch_done[DONE_FIRE3_2] & FIRE3_WINGS2) == 0)
	{
	  synch_done[DONE_FIRE3_2] |= FIRE3_WINGS2;
	  angle = attack_angle (e);
	  fire_stream (enemy[e].x, enemy[e].y - 10000, angle, EBCOL_B1,
		       2700 + arena.difficulty * 150, 90);
	...
	if (synch_ready[EVENT_FIRE3_1])
	{
	  ...
	  if (enemy[e].status == 0)
	  {
	    ...
	    {
	      fire_sdart (enemy[e].x + xpart (angle, 9000),
			  enemy[e].y + ypart (angle, 9000), angle, EBCOL_B5,
			  50, 90);
	      angle += angle_inc;
	      angle &= 1023;
	    }
	    ...
	    && !(synch_done[DONE_FIRE4_2] & FIRE4_HUNTER))
	{
	  synch_done[DONE_FIRE4_2] |= FIRE4_HUNTER;
	  enemy[e].recycle = 90 - arena.difficulty * 15;
	  fire_tracker (enemy[e].x - 6000, enemy[e].y - 18000,
			ANGLE_2 + ANGLE_4 - ANGLE_32, EBCOL_B2, 4, 500);
	  fire_tracker (enemy[e].x + 6000, enemy[e].y - 18000,
			ANGLE_2 + ANGLE_4 + ANGLE_32, EBCOL_B2, 4, 500);

	  fire_tracker (enemy[e].x - 13000, enemy[e].y - 10000,
			ANGLE_2 + ANGLE_8, EBCOL_B2, 4, 500);
	  fire_tracker (enemy[e].x + 13000, enemy[e].y - 10000, -ANGLE_8,
			EBCOL_B2, 4, 500);

	  fire_tracker (enemy[e].x - 16000, enemy[e].y + 1000, ANGLE_2,
			EBCOL_B2, 4, 500);
	  fire_tracker (enemy[e].x + 16000, enemy[e].y + 1000, 0, EBCOL_B2, 4,
			500);

	  fire_tracker (enemy[e].x - 13000, enemy[e].y + 12000,
			ANGLE_4 + ANGLE_8, EBCOL_B2, 4, 500);
	  fire_tracker (enemy[e].x + 13000, enemy[e].y + 12000, ANGLE_8,
			EBCOL_B2, 4, 500);
...
//     enemy[e].target_time ++;
  ...
  case 4:			// departing
	...
	quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 27000,
      ...
      break;
    case ENEMY_RISER:
      quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 24000,
		   enemy[e].x_speed + grand (300) - grand (300),
		   enemy[e].y_speed + 1500 + grand (2500), 8 + grand (5),
		   TCOL_SH2, 0);
//      quick_cloud(CLOUD_CIRCLE2, enemy[e].x + 40000, enemy[e].y + 27000, enemy[e].x_speed + grand(300) - grand(300), enemy[e].y_speed + 1500 + grand(2500), 8 + grand(4), TCOL_SH2, 0);
  ...
  case ENEMY_RISER:
    ...
    quick_cloud (CLOUD_CIRCLE2, enemy[e].x, enemy[e].y + 24000,
		 enemy[e].x_speed + grand (300) - grand (300),
		 enemy[e].y_speed + 1500 + grand (2500), 4 + grand (3),
		 TCOL_SH2, 0);
    break;
  case ENEMY_BEAMER:
    if (enemy[e].phase == 1)
...
/*  ebullet[b].cord_x = x;
  ...
  ebullet[b].sprite_angle = angle / (ANGLE_1 / SMALL_ROTATIONS);*/
    ...
    ebullet[b].cord_wait = -1;
    quick_cloud (CLOUD_CIRCLE5, ebullet[b].x, ebullet[b].y, 0, 0, 30, TCOL_B2,
		 0);
//  ebullet[b].accel = accel;
    return b;
  }
...
int fire_beam (int e, int dist)
{
  ...
  if (b != -1)
  {
    ...
    {
      ebullet[b].x =
	enemy[e].x + xpart (enemy[e].angle1,
			    dist + 4000 - (enemy[e].status % 6) * GRAIN * 4);
      ebullet[b].y =
	enemy[e].y + ypart (enemy[e].angle1,
			    dist + 4000 - (enemy[e].status % 6) * GRAIN * 4);
    }
    ebullet[b].status = length;
    ebullet[b].angle = enemy[e].angle1;
...
void set_cord_colour (int b)
{
  ...
  case EBCOL_B4:
    ...
    break;
  case EBCOL_B5:
    ebullet[b].cord_colour = TRANS_B5_OUT;
    break;
  }
...
{
  return
    radians_to_angle (atan2 (player.y - enemy[e].y, player.x - enemy[e].x));
}
...
//   rel_y = 2000;
    int dam =
      (pbullet[b].dam + (pbullet[b].dam * hypot (rel_y, rel_x) / 200)) / 160;
...
int hurt_enemy (int e, int dam, int source)
{
  ...
  if (enemy[e].type == ENEMY_BOSS1
      ...
      || enemy[e].type == ENEMY_BOSS3 || enemy[e].type == ENEMY_BOSS4)
  {
    boss.hp -= dam;
    if (boss.hp <= 0)
    {
...
void enemy_explode (int e)
{
  ...
  case ENEMY_SWOOPER1:
    ...
    {
      angle += ANGLE_4;
      quick_cloud (CLOUD_CIRCLE1, x, y, xpart (angle, 2000),
		   ypart (angle, 2000), 20, TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE1, x, y, xpart (angle, 1500),
		   ypart (angle, 1500), 20, TCOL_YELLOW, 0);
    }
/*   quick_cloud(CLOUD_CIRCLE1, x, y, -1500, 1500, 20, 7, 0);
  ...
  case ENEMY_SWOOPER2:
    ...
    {
      angle += ANGLE_1 / 7;
      quick_cloud (CLOUD_CIRCLE1, x, y, xpart (angle, 1200),
		   ypart (angle, 1200), 30, TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x, y, xpart (angle, 1220),
		   ypart (angle, 1220), 30, TCOL_YELLOW, 0);
    }
    break;
  case ENEMY_DARTER2:
    ...
    {
      angle += ANGLE_6;
      quick_cloud (CLOUD_CIRCLE1, x + xpart (angle, 43000),
		   y + ypart (angle, 28000), xpart (angle, 1000),
		   ypart (angle, 1000), 20, TCOL_YELLOW, 0);
      angle += ANGLE_6;
      quick_cloud (CLOUD_CIRCLE3, x + xpart (angle, 43000),
		   y + ypart (angle, 28000), xpart (angle, 1000),
		   ypart (angle, 1000), 30, TCOL_ORANGE, 0);
    }
    break;
  case ENEMY_DARTER1:
    play_effectwfvx (WAV_BANG, tone[NOTE_1G], 250, x);
...
//   quick_cloud(CLOUD_MSHOCK, x, y, 0, 0, 16, 1, 0);
    ...
    {
      angle += ANGLE_6;
      quick_cloud (CLOUD_CIRCLE1, x + xpart (angle, 28000),
		   y + ypart (angle, 28000), xpart (angle, 1000),
		   ypart (angle, 1000), 20, TCOL_YELLOW, 0);
      angle += ANGLE_6;
      quick_cloud (CLOUD_CIRCLE3, x + xpart (angle, 28000),
		   y + ypart (angle, 28000), xpart (angle, 1000),
		   ypart (angle, 1000), 30, TCOL_ORANGE, 0);
/*    angle += ANGLE_6;
...
/*   quick_cloud(CLOUD_CIRCLE2, x, y, 0, 0, 70, TCOL_SH2, 0);
  ...
  case ENEMY_POD1:
    ...
    for (i = 0; i < 8; i++)
    {
      angle += ANGLE_8;
      angle &= 1023;
      quick_cloud (CLOUD_CIRCLE1, x + xpart (angle, 10000),
		   y + ypart (angle, 10000), xpart (angle, 1800),
		   ypart (angle, 1800), 60, TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x + xpart (angle, 10000),
		   y + ypart (angle, 10000), xpart (angle, 1800),
		   ypart (angle, 1800), 50, TCOL_YELLOW, 0);
    }
  ...
  case ENEMY_SMALL:
    ...
    {
      c =
	quick_cloud (CLOUD_PETAL1_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 36000),
		     y + ypart (enemy[e].petal_angle[i], 36000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 1800),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 1800),
		     5000, 0, 0);
      if (c != -1)
      {
...
/*   quick_cloud(CLOUD_CIRCLE3, x, y, 0, 0, 30, TCOL_SH1, 0);
   ...
   quick_cloud(CLOUD_MSHOCK, x, y, 0, 0, 60, 2, 0);*/
    for (i = 0; i < 4; i++)
    {
      c =
	quick_cloud (CLOUD_PETAL1_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 43000),
		     y + ypart (enemy[e].petal_angle[i], 43000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 1800),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 1800),
		     5000, 0, 0);
//    c = quick_cloud(CLOUD_PETAL1, x + xpart(enemy[e].petal_angle [i], 33000), y + ypart(enemy[e].petal_angle [i], 33000), 0, 0, 50, 0, 0);
  ...
  case ENEMY_LARGER2:
    ...
    {
      c =
	quick_cloud (CLOUD_PETAL2_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 33000),
		     y + ypart (enemy[e].petal_angle[i], 33000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 2400),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 2400),
		     5000, 0, 0);
      if (c != -1)
      {
	cloud[c].angle = enemy[e].petal_angle[i];
  ...
  case ENEMY_WINGS:
    ...
    {
      c =
	quick_cloud (CLOUD_PETAL3_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 55000),
		     y + ypart (enemy[e].petal_angle[i], 55000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 1800),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 1800),
		     5000, 0, 0);
      if (c != -1)
    ...
    for (i = 2; i < 4; i++)
    {
      c =
	quick_cloud (CLOUD_PETAL1_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 42000),
		     y + ypart (enemy[e].petal_angle[i], 42000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 2100),
    ...
    for (i = 4; i < 6; i++)
    {
      c =
	quick_cloud (CLOUD_PETAL2_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 35000),
		     y + ypart (enemy[e].petal_angle[i], 35000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 2400),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 2400),
		     5000, 0, 0);
      if (c != -1)
  ...
  case ENEMY_WINGS2:
    ...
    c =
      quick_cloud (CLOUD_PETAL2_DEBRIS, x + xpart (ANGLE_4, 42000),
		   y + ypart (ANGLE_4, 42000),
		   enemy[e].x_speed + xpart (ANGLE_4, 2100),
		   enemy[e].y_speed + ypart (ANGLE_4, 2100), 5000, 0, 0);
    if (c != -1)
    {
  ...
  case ENEMY_MEGA:
    ...
    for (i = 0; i < 4; i++)
    {
      quick_cloud (CLOUD_CIRCLE2, x + xpart (ANGLE_8 + i * ANGLE_4, 60000),
		   y + ypart (ANGLE_8 + i * ANGLE_4, 60000), 0, 0, 80,
		   TCOL_SH1, 0);
      quick_cloud (CLOUD_CIRCLE3, x + xpart (ANGLE_8 + i * ANGLE_4, 60000),
		   y + ypart (ANGLE_8 + i * ANGLE_4, 60000), 0, 0, 80,
		   TCOL_SH2, 0);
      c =
	quick_cloud (CLOUD_PETAL3_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 75000),
		     y + ypart (enemy[e].petal_angle[i], 75000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 1800),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 1800),
		     5000, 0, 0);
      if (c != -1)
    ...
    for (i = 4; i < 7; i++)
    {
      c =
	quick_cloud (CLOUD_PETAL1_DEBRIS,
		     x + xpart (enemy[e].petal_angle[i], 65000),
		     y + ypart (enemy[e].petal_angle[i], 65000),
		     enemy[e].x_speed + xpart (enemy[e].petal_angle[i], 2100),
		     enemy[e].y_speed + ypart (enemy[e].petal_angle[i], 2100),
		     5000, 0, 0);
      if (c != -1)
  ...
  case ENEMY_BOSS3:
    ...
    {
      xa += ANGLE_5;
      quick_cloud (CLOUD_CIRCLE2, x + xpart (xa, 60000),
		   y + ypart (xa, 60000), 0, 0, 80, TCOL_SH1, 0);
      quick_cloud (CLOUD_CIRCLE3, x + xpart (xa, 60000),
		   y + ypart (xa, 60000), 0, 0, 80, TCOL_SH2, 0);
    }
    xa = grand (ANGLE_1);
    for (i = 0; i < 9; i++)
    {
      xa += ANGLE_9;
      quick_cloud (CLOUD_CIRCLE2, x + xpart (xa, 90000),
		   y + ypart (xa, 90000), 0, 0, 80, TCOL_SH1, 0);
      quick_cloud (CLOUD_CIRCLE3, x + xpart (xa, 90000),
		   y + ypart (xa, 90000), 0, 0, 80, TCOL_SH2, 0);
    }
    for (i = 0; i < 5; i++)
    {
      ...
      c = quick_cloud (CLOUD_PETAL3_DEBRIS,
		       x + xpart (xa, boss.petal_out[2] * GRAIN),
		       y + ypart (xa, boss.petal_out[2] * GRAIN),
		       enemy[e].x_speed + xpart (xa, 1000),
		       enemy[e].y_speed + ypart (xa, 1000), 5000, 0, 0);
      if (c != -1)
      {
    ...
    for (i = 0; i < 7; i++)
    {
      ...
      c = quick_cloud (CLOUD_PETAL1_DEBRIS,
		       x + xpart (xa, boss.petal_out[1] * GRAIN),
		       y + ypart (xa, boss.petal_out[1] * GRAIN),
		       enemy[e].x_speed + xpart (xa, 1000),
		       enemy[e].y_speed + ypart (xa, 1000), 5000, 0, 0);
      if (c != -1)
      {
    ...
    for (i = 0; i < 9; i++)
    {
      ...
      c = quick_cloud (CLOUD_PETAL2_DEBRIS,
		       x + xpart (xa, boss.petal_out[0] * GRAIN),
		       y + ypart (xa, boss.petal_out[0] * GRAIN),
		       enemy[e].x_speed + xpart (xa, 1000),
		       enemy[e].y_speed + ypart (xa, 1000), 5000, 0, 0);
      if (c != -1)
      {
  ...
  case ENEMY_ESCORT:
    ...
    quick_cloud (CLOUD_BURN, x, y, -3500 - grand (1000), -1500 - grand (1000),
		 40 + grand (20), 0, 990);
    quick_cloud (CLOUD_BURN, x, y, 3500 + grand (1000), -2000 - grand (1000),
		 40 + grand (20), 0, 990);
    for (i = 0; i < 10; i++)
    {
      angle = grand (ANGLE_1);
      xa = 4000 + grand (3000);
      quick_cloud (CLOUD_CIRCLE5, x + xpart (angle, 5000),
		   y + xpart (angle, 5000), xpart (angle, xa), ypart (angle,
								      xa),
		   30 + grand (30), TCOL_ORANGE, 900);
    }
    break;
  case ENEMY_DRIFTER2:
    ...
    for (i = 0; i < 15; i++)
    {
      angle = grand (ANGLE_1);
      xa = 4000 + grand (3000);
      quick_cloud (CLOUD_CIRCLE3, x + xpart (angle, 5000),
		   y + xpart (angle, 5000), xpart (angle, xa), ypart (angle,
								      xa),
		   30 + grand (30), TCOL_ORANGE, 930);
    }
    break;
  case ENEMY_RISER:
  ...
  case ENEMY_SHOOTER:
    ...
    for (i = 0; i < 5; i++)
    {
      ...
      angle &= 1023;
      xa = 5000 + grand (3000);
      quick_cloud (CLOUD_BURN, x + xpart (angle, 5000),
		   y + ypart (angle, 5000), xpart (angle, xa), ypart (angle,
								      xa),
		   80 + grand (40), 8, 990);
    }
    for (i = 0; i < 10; i++)
  ...
  case ENEMY_CRUISER3:
    ...
    quick_cloud (CLOUD_CIRCLE1, x, y + 50000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x, y + 50000, 0, 0, 40 + grand (20),
		 TCOL_YELLOW, 0);
    quick_cloud (CLOUD_CIRCLE1, x, y - 40000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x, y - 40000, 0, 0, 40 + grand (20),
		 TCOL_YELLOW, 0);

    if (enemy[e].type == ENEMY_CRUISER1)
    {
      quick_cloud (CLOUD_CIRCLE1, x - 42000, y + 55000, 0, 0, 40 + grand (20),
		   TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x - 42000, y + 55000, 0, 0, 40 + grand (20),
		   TCOL_YELLOW, 0);
      quick_cloud (CLOUD_CIRCLE1, x + 42000, y + 55000, 0, 0, 40 + grand (20),
		   TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x + 42000, y + 55000, 0, 0, 40 + grand (20),
      ...
      quick_cloud (CLOUD_CIRCLE1, x - 16000, y + 61000, 0, 0, 40 + grand (20),
		   TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x - 16000, y + 61000, 0, 0, 40 + grand (20),
		   TCOL_YELLOW, 0);
      quick_cloud (CLOUD_CIRCLE1, x + 16000, y + 61000, 0, 0, 40 + grand (20),
		   TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x + 16000, y + 61000, 0, 0, 40 + grand (20),
    ...
    {
      quick_cloud (CLOUD_CIRCLE1, x - 47000, y + 49000, 0, 0, 50 + grand (30),
		   TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x - 47000, y + 49000, 0, 0, 50 + grand (30),
		   TCOL_YELLOW, 0);
      quick_cloud (CLOUD_CIRCLE1, x + 47000, y + 49000, 0, 0, 50 + grand (30),
		   TCOL_ORANGE, 0);
      quick_cloud (CLOUD_CIRCLE2, x + 47000, y + 49000, 0, 0, 50 + grand (30),
  ...
  case ENEMY_CRUISER2:
    ...
    quick_cloud (CLOUD_CIRCLE1, x - 42000, y + 14000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x - 42000, y + 14000, 0, 0, 40 + grand (20),
		 TCOL_YELLOW, 0);
    quick_cloud (CLOUD_CIRCLE1, x + 42000, y + 14000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x + 42000, y + 14000, 0, 0, 40 + grand (20),
		 TCOL_YELLOW, 0);
    quick_cloud (CLOUD_CIRCLE1, x, y + 39000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x, y + 39000, 0, 0, 40 + grand (20),
		 TCOL_YELLOW, 0);
  ...
  case ENEMY_CRUISER4:
    ...
    quick_cloud (CLOUD_CIRCLE1, x - 14000, y + 45000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x - 14000, y + 45000, 0, 0, 40 + grand (20),
		 TCOL_YELLOW, 0);
    quick_cloud (CLOUD_CIRCLE1, x + 14000, y + 45000, 0, 0, 40 + grand (20),
		 TCOL_ORANGE, 0);
    quick_cloud (CLOUD_CIRCLE2, x + 14000, y + 45000, 0, 0, 40 + grand (20),
  ...
  case ENEMY_BOSS1:
    ...
    for (i = 0; i < 8; i++)
    {
      quick_cloud (CLOUD_CIRCLE3, x - 71000 + xpart (angle, 40000),
		   y + ypart (angle, 40000), 0, 0, 85, TCOL_SH1, 0);
      quick_cloud (CLOUD_CIRCLE5, x - 71000 + xpart (angle, 40000),
		   y + ypart (angle, 40000), 0, 0, 85, TCOL_SH2, 0);
    ...
    for (i = 0; i < 16; i++)
    {
      quick_cloud (CLOUD_CIRCLE3, x + xpart (angle, 100000),
		   y + ypart (angle, 70000), xpart (angle, 1600),
		   ypart (angle, 1120), 100, TCOL_SH1, 990);
      quick_cloud (CLOUD_CIRCLE5, x + xpart (angle, 100000),
		   y + ypart (angle, 70000), xpart (angle, 1600),
		   ypart (angle, 1120), 100, TCOL_SH2, 990);
  ...
  case ENEMY_BOSS2:
    ...
    quick_cloud (CLOUD_CIRCLE1, x - 53000, y + 40000, 0, 0, 50, TCOL_ORANGE,
		 0);
    quick_cloud (CLOUD_CIRCLE2, x - 53000, y + 40000, 0, 0, 50, TCOL_YELLOW,
		 0);
    ...
    quick_cloud (CLOUD_CIRCLE1, x - 32000, y - 20000, 0, 0, 50, TCOL_ORANGE,
		 0);
    quick_cloud (CLOUD_CIRCLE2, x - 32000, y - 20000, 0, 0, 50, TCOL_YELLOW,
		 0);
    ...
    for (i = 0; i < 4; i++)
    {
      ...
      angle &= 1023;
      xa = 6000 + grand (3000);
      quick_cloud (CLOUD_BURN, x + xpart (angle, 25000),
		   y + ypart (angle, 25000), xpart (angle, xa), ypart (angle,
								       xa),
		   250 + grand (50), 0, 970);
    }
    angle = grand (ANGLE_1);
    ...
    for (i = 0; i < 15; i++)
    {
      angle = grand (ANGLE_1);
      xa = 4000 + grand (4000);
      quick_cloud (CLOUD_CIRCLE5, x + xpart (angle, 25000),
		   y + xpart (angle, 25000), xpart (angle, xa), ypart (angle,
								       xa),
		   80 + grand (30), TCOL_ORANGE, 950);
    }
    break;
  ...
  case ENEMY_DROPPER:
    ...
    c =
      quick_cloud (CLOUD_DELAY1, x - 15000, y + 21000, 0, 0, 3000, TCOL_SH1,
		   0);
    if (c != 0)
    {
      cloud[c].angle = 7;
  ...
  case ENEMY_RING:
    ...
    quick_cloud (CLOUD_SCIRCLE, x, y, 0, 0, enemy[e].status / 2, TRANS_B3_OUT,
		 0);
    c =
      quick_cloud (CLOUD_DELAY1, x - 29000, y - 29000, 0, 0, 3000, TCOL_SH1,
		   0);
    if (c != 0)
    {
      cloud[c].angle = 10;
...
//   quick_cloud(CLOUD_CIRCLE2, x, y, 0, 0, 80, TCOL_SH1, 0);
  ...
  case ENEMY_BOSS4:
    ...
    quick_cloud (CLOUD_SCIRCLE, x - 70000, y - 61000, 0, 0, boss.spin_rad,
		 TRANS_B2_OUT, 0);
    quick_cloud (CLOUD_SCIRCLE, x + 70000, y - 61000, 0, 0, boss.spin_rad,
		 TRANS_B2_OUT, 0);

    quick_cloud (CLOUD_SCIRCLE, x, y + 25000, 0, 0, boss.spin_rad2,
		 TRANS_B3_OUT, 0);

    angle = boss.spin_angle2;

    quick_cloud (CLOUD_SCIRCLE, x + xpart (angle, boss.spin_rad2 * GRAIN),
		 y + ypart (angle, boss.spin_rad2 * GRAIN) + 25000, 0, 0,
		 boss.spin_rad3, TRANS_B1_OUT, 0);
    angle += ANGLE_3;
    quick_cloud (CLOUD_SCIRCLE, x + xpart (angle, boss.spin_rad2 * GRAIN),
		 y + ypart (angle, boss.spin_rad2 * GRAIN) + 25000, 0, 0,
		 boss.spin_rad3, TRANS_B1_OUT, 0);
...
void allocate_xp (int e)
{
  ...
  if (boss.fight
      && (enemy[e].type == ENEMY_SMALL || enemy[e].type == ENEMY_SMALL2))
    return;
...
void register_destroyed (int e)
{
  ...
  if (player.weapon[0] == WPN_SEEKER
      || player.weapon[1] == WPN_SEEKER || player.weapon[2] == WPN_SEEKER)
  {

    ...
    switch(ebullet[b].type)
    {
            ...
            if (ebullet[b].cord_wait == -1)
            {
              ...
              if (ebullet[b].x_speed < 500 && ebullet[b].x_speed > -500
               && ebullet[b].y_speed < 500 && ebullet[b].y_speed > -500)
               {
                ...
                quick_cloud(CLOUD_CIRCLE2, ebullet[b].x, ebullet[b].y, 0, 0, 15, TCOL_B5, 0);
               }
            }
            ebullet[b].x += ebullet[b].x_speed;
            ebullet[b].y += ebullet[b].y_speed;
        ...
        case EBULLET_STREAM:
            ...
            if (ebullet[b].time % 20 == 0)
            {
              ...
              angle &= 1023;
              k = fire_dart(ebullet[b].x + xpart(angle, 10000), ebullet[b].y + ypart(angle, 10000), angle, EBCOL_B1, 60, 80);
              if (k != -1)
              {
...
//              k = fire_ddart(ebullet[b].x + xpart(angle, 22000), ebullet[b].y + ypart(angle, 22000), angle, EBCOL_B2, 60, 60);
              k = fire_diamond(ebullet[b].x + xpart(angle, 25000), ebullet[b].y + ypart(angle, 25000), angle, EBCOL_B2, 2000, ebullet[b].status / 2, 30);
              if (k != -1)
              {
               ebullet[k].new_ebullet = 0;
               ebullet[k].cord_x = ebullet[b].x;
              ...
              angle += ANGLE_6;
              angle &= 1023;
              k = fire_dart(ebullet[b].x + xpart(angle, 20000), ebullet[b].y + ypart(angle, 20000), angle, EBCOL_B1, 60, 30);
              if (k != -1)
              {
               ebullet[k].new_ebullet = 0;
               ebullet[k].cord_x = ebullet[b].x;

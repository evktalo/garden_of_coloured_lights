       ...
       break;
        case CLOUD_BURN:
         ...
         if (cloud[c].timeout & 1)
          quick_cloud(CLOUD_CIRCLE5, cloud[c].x + grand(8000) - grand(8000), cloud[c].y + grand(8000) - grand(8000), cloud[c].x_speed, cloud[c].y_speed, cloud[c].timeout / 3 + 18 + grand(15), TCOL_SH2, 900);
           else
            quick_cloud(CLOUD_CIRCLE3, cloud[c].x + grand(8000) - grand(8000), cloud[c].y + grand(8000) - grand(8000), cloud[c].x_speed, cloud[c].y_speed, cloud[c].timeout / 8 + 10 + grand(10), TCOL_ORANGE, 900);
        ...
        case CLOUD_SPAWNER:
         ...
         cloud[c].y += cloud[c].y_speed;
//         if (grand(3) == 0)
         quick_cloud(CLOUD_CIRCLE2, cloud[c].x + grand(18000) - grand(18000), cloud[c].y + grand(18000) - grand(18000), 0, 0, 20 + grand(20), cloud[c].colour, 950);
         break;
        case CLOUD_MSHOCK:
//         if (arena.counter % 8 != 0)
//              cloud[c].timeout ++;
